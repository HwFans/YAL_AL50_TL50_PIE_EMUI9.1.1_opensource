...
static u8 *idtp9221_get_chip_info(void)
{
	return "idtp9221";
}
...
static void idtp9221_get_tx_extra_capability(struct tx_capability *tx_cap)
{
	...
	tx_cap->support_qval = tx_extra_cap_data[TX_EXTRA_CAP_ATTR1] &
		IDT9221_TX_CAP_SUPPORT_QVAL_MASK;
	hwlog_info("support: fan=%d, tec=%d, qval=%d\n",
...
static struct wireless_charge_device_ops idtp9221_ops = {
	...
	.get_chip_info          = idtp9221_get_chip_info,
