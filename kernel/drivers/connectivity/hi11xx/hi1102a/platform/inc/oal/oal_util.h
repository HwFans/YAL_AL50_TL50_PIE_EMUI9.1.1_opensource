...
#define OAL_ANY_NULL_PTR1(_ptr1)                             ((NULL == (_ptr1)))
#define OAL_ANY_NULL_PTR2(_ptr1, _ptr2)                      ((NULL == (_ptr1)) || (NULL == (_ptr2)))
#define OAL_ANY_NULL_PTR3(_ptr1, _ptr2, _ptr3)               ((NULL == (_ptr1)) || (NULL == (_ptr2)) || (NULL == (_ptr3)))
#define OAL_ANY_NULL_PTR4(_ptr1, _ptr2, _ptr3, _ptr4)        ((NULL == (_ptr1)) || (NULL == (_ptr2)) || (NULL == (_ptr3)) || (NULL == (_ptr4)))
#define OAL_ANY_NULL_PTR5(_ptr1, _ptr2, _ptr3, _ptr4, _ptr5) ((NULL == (_ptr1)) || (NULL == (_ptr2)) || (NULL == (_ptr3)) || (NULL == (_ptr4)) || (NULL == (_ptr5)))
...
/*
 * 函 数 名  : oal_print_inject_check_stack
 * 功能描述  : 无
 * 输入参数  : 无
 * 输出参数  : 无
 * 返 回 值  : 无
...
{
    memcpy_s(puc_mac_addr1, OAL_MAC_ADDRESS_LAN, puc_mac_addr2, OAL_MAC_ADDRESS_LAN);
}
